package com.example.vvnotes.model;
...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> implements Filterable {
    ...
    List<String> content;
    List<String>ilist;
    FirestoreRecyclerAdapter<Note, MainActivity.NoteViewHolder> noteAdapter;
    ...
    Filter myFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (charSequence == null || charSequence.length() == 0) {
                filteredList.addAll(ilist);
            } else {
                for (String movie: ilist) {
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            ilist.clear();
            ilist.addAll((Collection<? extends String>) filterResults.values);
